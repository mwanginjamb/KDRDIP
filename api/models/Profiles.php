...
class Profiles extends \yii\db\ActiveRecord
{
	...
	{
		return $this->hasOne(Users::className(), ['ProfileID' => 'CreatedBy'])->from(profiles::tableName());
	}

	public function getProfilestatus() 
	{
		return $this->hasOne(UserStatus::className(), ['ProfileStatusID' => 'ProfileStatusID'])->from(profilestatus::tableName());
	}
}
