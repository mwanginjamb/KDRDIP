				...
				<div class="card-content collapse show">
					<div class="card-body card-dashboard">
						<div class="form-actions" style="margin-top:0px">
                            ...
                            <?= Html::a('<i class="fa fa-file-excel"></i> Excel Import', ['excel-import'], ['class' => 'btn btn-success mr-1','title' =>  'Do a batch data upload via an Excel Sheet. '])?>
                            <?= Html::a('<i class="fa fa-download"></i> Download Template', \yii\helpers\Url::home(true)."templates/BankAccountTemplate.xlsx", ['class' => 'btn btn-info mr-1','title' => 'Get Bank Accounts data import sample excel template here.'])?>
						</div>
								...
								[
									...
									'buttons' => [
										...
										'view' => function ($url, $model) use ($rights) {
											return (isset($rights->View)) ? Html::a('<i class="ft-eye"></i> View', ['view', 'id' => $model->BankAccountID], ['class' => 'btn-sm btn-primary']) : '';
										},
										'delete' => function ($url, $model) use ($rights) {
											return (isset($rights->Delete)) ? Html::a('<i class="ft-trash"></i> Delete', ['delete', 'id' => $model->BankAccountID], [
