				...
				<div class="card-content collapse show">
					<div class="card-body card-dashboard">
						<div class="form-actions" style="margin-top:0px">
                            ...
                            <?= Html::a('<i class="fa fa-download"></i> Download Template', \yii\helpers\Url::home(true)."templates/BankAccounts.xlsx", ['class' => 'btn btn-info mr-1','title' => 'Get Bank Accounts data import sample excel template here.'])?>
						</div>
