...
$this->title = 'Assigned Complaints: ' . $model->ComplainantName;
			...
			<div class="card">
				...
				<div class="card-content collapse show">
					...
					<p>
							...
							<?= (isset($rights->Edit) && $rights->Edit) ? Html::a('<i class="ft-user"></i> Re-Assign', null, ['class' => 'btn btn-primary mr-1', 'style' => 'color: white', 'onclick' => 'reAssign()']) : '' ?>
