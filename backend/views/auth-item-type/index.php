...
/* @var $searchModel frontend\models\AuthItemTypeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Auth Item Types';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="auth-item-type-index">

    <h1><?= Html::encode($this->title) ?></h1>

    <p>
        <?= Html::a('Create Auth Item Type', ['create'], ['class' => 'btn btn-success']) ?>
    </p>
