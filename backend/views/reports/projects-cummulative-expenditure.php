...
?>
<p>Project Status - <?= $projectStatusName != '' ? $projectStatusName : 'All' ?></p>
<p>Component - <?= $componentName != '' ? $componentName : 'All' ?></p>
<p>Date Range: Start Date - (<?= $startDate . ' to ' . $endDate; ?> )</p>
...
<tr>
	...
	<th width="13%" align="right">Cummulative Expenditure</th>
	...
	foreach ($projects as $key => $project) {
		...
		<tr>
			...
			<td align="right"><?= number_format($project->CummulativeExpenditure,2); ?></td>
