			...
			<div class="card">
				...
				<div class="card-content collapse show">
					<div class="card-body card-dashboard">
						...
						<div class="row">
							<div class="col-md-2">
								<?= $form->field($filter, 'ComponentID')->dropDownList($components, [
									'prompt' => 'All', 'class' => 'select2 form-control',
									'onchange' => '
						...
						<div class="row">
							<div class="col-md-3">
								<?= $form->field($filter, 'CountyID')->dropDownList($counties, [
									'prompt' => 'All', 'class' => 'select2 form-control',
									'onchange' => '
							...
							<div class="col-md-3">
								<?= $form->field($filter, 'SubCountyID')->dropDownList($subCounties, [
									'prompt' => 'All', 'class' => 'select2 form-control',
									'onchange' => '
							...
							<div class="col-md-3">
								<?= $form->field($filter, 'WardID')->dropDownList($wards, [
									'prompt' => 'All', 'class' => 'select2 form-control',
									'onchange' => '
								...
								[
									...
									'buttons' => [
										...
										'view' => function ($url, $model) {
											return Html::a('<i class="ft-eye"></i> View', ['view', 'id' => $model->ComplaintID], ['class' => 'btn-sm btn-primary']);
										},
										'delete' => function ($url, $model) {
											return Html::a('<i class="ft-trash"></i> Delete', ['delete', 'id' => $model->ComplaintID], [
