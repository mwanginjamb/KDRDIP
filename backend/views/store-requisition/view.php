				...
				<div class="card-content collapse show">
					<div class="card-body">	
						...
						{ ?>
							...
							<?= (isset($rights->Edit)) ? Html::a('<i class="ft-edit"></i> Update', ['update', 'id' => $model->StoreRequisitionID], ['class' => 'btn btn-primary']) : '';?>
							<?= (isset($rights->Delete)) ? Html::a('<i class="ft-trash"></i> Delete', ['delete', 'id' => $model->StoreRequisitionID], [
