...
$this->title = ($option==1) ? 'Cash Disbursement Review' : 'Cash Disbursement Approvals';
switch ($option) {
	case 1:
								...
								[
									...
									'buttons' => [
										...
										'update' => function ($url, $model) use ($Rights, $FormID, $option, $rights) {
											...
											return (isset($rights->Delete)) ? Html::a('<i class="ft-eye"></i> Select', $baseUrl.'/cash-disbursement-approvals/view?id=' . $model->CashDisbursementID.'&option=' . $option, [
