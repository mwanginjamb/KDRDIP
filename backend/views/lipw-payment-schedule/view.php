				...
				<div class="card-content collapse show">
					<div class="card-body">	
						...
						<ul class="nav nav-tabs nav-top-border no-hover-bg">
							...
							<li class="nav-item">
								<a class="nav-link" id="base-tab2" data-toggle="tab" aria-controls="tab2" href="#tab2" aria-expanded="false" onclick="loadpage('<?= Yii::$app->urlManager->createUrl('lipw-payment-request-lines/index?pId=' . $model->PaymentRequestID . '&mId=' . $model->MasterRollID);?>', 'tab2')">Eligible Workers</a>
							</li>	
							<li class="nav-item">
