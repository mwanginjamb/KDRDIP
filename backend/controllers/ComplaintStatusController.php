...
class ComplaintStatusController extends Controller
{
	...
	{
		$this->rights = RightsController::Permissions(83);
	...
	/**
	 * Displays a single ComplaintStatus model.
	 * @param integer $id
	 * @return mixed
	...
	public function actionCreate()
	{
		...
		if ($model->load(Yii::$app->request->post()) && $model->save()) {
			return $this->redirect(['view', 'id' => $model->ComplaintStatusID]);
		}
