 ...
 */
class ComplaintsClosedController extends Controller
{
	public $rights;
	/**
	 * @inheritdoc
	...
	{
		$this->rights = RightsController::Permissions(129);
	...
	public function actionIndex()
	{
		...
		// print_r($filter); exit;
		$model->andWhere(['complaints.ComplaintStatusID' => 5]);
	...
	public function actionView($id)
	{
		...
		$complaintStatus = ArrayHelper::map(ComplaintStatus::find()->andWhere('ComplaintStatusID IN (4)')->all(), 'ComplaintStatusID', 'ComplaintStatusName');
