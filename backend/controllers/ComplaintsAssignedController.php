 ...
 */
class ComplaintsAssignedController extends Controller
{
	public $rights;
	/**
	 * @inheritdoc
	...
	{
		$this->rights = RightsController::Permissions(127);
	...
	public function actionIndex()
	{
		...
		// print_r($filter); exit;
		$model->andWhere(['AssignedTo' => Yii::$app->user->identity->UserID]);
		$model->andWhere('complaints.complaintStatusId IN (3, 4, 5)');
	...
	public function actionView($id)
	{
		...
		$complaintStatus = ArrayHelper::map(ComplaintStatus::find()->andWhere('ComplaintStatusID IN (3, 4)')->all(), 'ComplaintStatusID', 'ComplaintStatusName');
