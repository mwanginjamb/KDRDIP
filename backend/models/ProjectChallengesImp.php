 ...
 */
class ProjectChallengesImp extends \yii\db\ActiveRecord
{
	/**
	 * {@inheritdoc}
	 */
	...
	{
		return [
			[['ProjectID', 'AssignedTo', 'CreatedBy', 'Deleted', 'ProjectChallengeStatusID', 'MajorChallenge'], 'integer'],
			[['Challenge', 'CorrectiveAction'], 'string'],
			[['AgreedDate', 'CreatedDate'], 'safe'],
			[['ProjectChallengeStatusID'], 'required'],
		];
	}
